...
from events.views import dashboard, create_event, update_event, details, delete_event, show_participant, delete_participants, show_category, delete_category, accept_invitation, Show_participants
